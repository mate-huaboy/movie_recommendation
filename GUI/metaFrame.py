...
class metaFrame():
    ...
    def __init__(self,movieId, userId ,window,Bigwindow,Allwindow,type="base",**kw):
        ...
        self.title, self.date, self.genres, self.briefinfo = metaFun_GUI.get_src(self.movieId)  # 爬得电影海报的scr等信息
        ...
        # 获得电影海报
        self.tk_image = metaFun_GUI.get_image(self.movieId)
    ...
    def createmovieinfo(self):
        ...
        GUI.movieInfo_window.movieinfo_window(self.Allwindow, self.Frame, self.movieId, self.userId)
        print("Done!")
