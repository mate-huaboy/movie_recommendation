...
class Search_window():
    ...
    def __init__(self,root,window,movieid,userid):
        ...
        GUI.metaButtons.NavigationBar(self.root, self.window, navbar_Frame, self.movieid, self.userid, type="S")
    ...
    def get_search(self):
        ...
        sql = "select movieid from dbmovierecommender.movies where title like '%{}%';".format(searchcontent)
        cur.execute(sql)
